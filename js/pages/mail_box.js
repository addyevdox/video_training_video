$(document).ready(function(){
    ...
    $(".mark_as_star").on("click",function(){
        $('.mail_inbox_all tr td .rating .fa-star').each(function () {
            if($(this).hasClass("text-warning")){
                $(this).closest('tr').addClass('unstar_background');
                $(this).closest('tr').find(".icheckbox_minimal-blue").addClass('checked');
            }
            else{
                $(this).closest('tr').find(".icheckbox_minimal-blue").removeClass('checked');
                $(this).closest('tr').removeClass('unstar_background');
            }
        });
    ...
    $('.mail_inbox_all tr td [type="checkbox"]').on('ifChanged',function () {
        ...
        $('.mail_inbox_all tr td [type="checkbox"]').each(function () {
            if($(this).closest("tr").find(".mail-checkbox").hasClass("checked")){
