                                                ...
                                                <div class="col-md-4">
                                                    <div style="margin: .8em 0 .5em;">
                                                        <span class="requiresjcrop">
                                                            <button id="setSelect" class="btn btn-mini btn-light">setSelect</button>
                                                            <button id="animateTo" class="btn btn-mini btn-light">animateTo</button>
                                                            <button id="release" class="btn btn-mini btn-light">Release</button>
                                                            <button id="disable" class="btn btn-mini btn-light">Disable</button>
                                                        </span>
                                                        <button id="enable" class="btn btn-mini btn-light" style="display:none;">Re-Enable</button>
                                                        <button id="unhook" class="btn btn-mini btn-light">Destroy!</button>
                                                        <button id="rehook" class="btn btn-mini btn-light" style="display:none;">Attach Jcrop</button>
                                                    </div>
