                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12 pop d-none d-sm-block">
                                        <h3>Popover</h3>
                                        <button type="button" class="btn btn-light" title="Popover title" data-container="body" data-toggle="popover" data-placement="left" data-content="Some content in Popover on left"  style="margin-bottom:10px;margin-left:10px;">Popover on left</button>
                                    ...
                                    <div class="col-md-12 pop d-block d-sm-none d-md-none d-lg-none">
                                        ...
                                        <p class="text-center"><button type="button" class="btn btn-light text-center" title="Popover title" data-container="body" data-toggle="popover" data-placement="left" data-content="Popover on left">Popover on left</button></p>
                                    </div>
                                    <div class="po-markup">
                                        <br>
