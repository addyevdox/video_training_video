                        ...
                        <form method="post" id="passwordForm">
                            ...
                            <div class="row my-3">
                                <div class="col-sm-6 col-lg-6 col-12">
                                    <span id="8char" class="fa fa-times color-pwd"></span><span  class="fnt-14"> 8 Characters Long</span>
                                    <br>
                                    <span id="ucase" class="fa fa-times color-pwd"></span><span  class="fnt-14"> One Uppercase Letter</span>
                                </div>
                                <div class="col-sm-6 col-lg-6 col-12">
                                    <span id="lcase" class="fa fa-times color-pwd"></span> <span  class="fnt-14"> One Lowercase Letter</span>
                                    <br>
                                    <span id="num" class="fa fa-times color-pwd"></span><span  class="fnt-14"> One Number</span>
                                </div>
                            </div>
                            ...
                            <div class="row my-2">
                                <div class="col-sm-12 col-lg-12 col-12">
                                    <span id="pwmatch" class="fa fa-times color-pwd"></span> <span  class="fnt-14">Passwords Match</span>
                                </div>
                            </div>
