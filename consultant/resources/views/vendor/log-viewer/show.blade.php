                            ...
                            {{--<div class="card card-default">--}}
                                ...
                                {{--<div class="card-footer">--}}
                                    ...
                                    {{--@if (request()->has('query'))--}}
                                                        {{--<a href="{{ route('log-viewer::logs.show', [$log->date]) }}" class="btn btn-light"><span class="glyphicon glyphicon-remove"></span></a>--}}
                                                    {{--@endif--}}
            ...
            <form id="delete-log-form" action="{{ URL::to('admin/log_viewers/logs/delete') }}" method="POST">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-sm btn-light float-left" data-dismiss="modal">Cancel</button>
