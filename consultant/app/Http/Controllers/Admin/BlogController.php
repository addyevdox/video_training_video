...
class BlogController extends JoshController
{
    ...
    public function index()
    {
        ...
        $blogs = Blog::all();
        // Show the page
        return view('admin.video.index', compact('blogs'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.video.create', compact('blogcategory'));
    }
    ...
    public function store(BlogRequest $request)
    {
        ...
        foreach($images as $img){
            ...
            if(preg_match('/data:image/', $src)){
                ...
                $filename = uniqid();
                $filepath = "uploads/video/$filename.$mimetype";
    ...
    public function show(Blog $blog)
    {
        ...
        return view('admin.video.show', compact('blog', 'comments', 'tags'));
    }
    ...
    {
        $blogcategory = BlogCategory::pluck('title', 'id');
        return view('admin.video.edit', compact('blog', 'blogcategory'));
    }
    ...
    public function update(BlogRequest $request, Blog $blog)
    {
        ...
        if ($blog->update($request->except('content','image','files','_method', 'tags'))) {
            return redirect('admin/video')->with('success', trans('video/message.success.update'));
        } else {
            return Redirect::route('admin/video')->withInput()->with('error', trans('video/message.error.update'));
        }
    }
    ...
    public function getModalDelete(Blog $blog)
    {
        ...
        try {
            $confirm_route = route('admin.video.delete', ['id' => $blog->id]);
    ...
    public function storeComment(BlogCommentRequest $request, Blog $blog)
    {
        ...
        $blogcooment->save();
        return redirect('admin/video/' . $blog->id );
    }
}
